...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "fleetdashboard/test/integration/FirstJourney",
    "fleetdashboard/test/integration/VehiclesListJourney",
    "fleetdashboard/test/integration/VehiclesObjectPageJourney",
    "fleetdashboard/test/integration/MaintenanceAlertsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
